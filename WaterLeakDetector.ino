...
void handle_NotFound(){
  ...
  ptr += "Headers: " + String(server.headers()) + "\n";
  ptr += "Arguments: " + String(server.args()) + "\n";
  server.send(404, "text/plain", ptr);
}
...
String SendHTML(String message, category c){
  ...
  ptr += "<!-- Inputs -->\n";
  ptr += "<form method=\"post\" action=\"/applyChangesButton\">\n";
  ptr += "    <div class=\"container\">\n";
  ptr += "        <h1>Inputs</h1>\n";
  ...
  ptr += "                    <input type=\"text\" class=\"form-control\" id=\"wifiName\" name=\"wifiName\" value=\"" + WiFi.SSID() + "\">\n";
  ptr += "                </div>\n";
  ptr += "                <div class=\"form-group\">\n";
  ptr += "                    <label for=\"wifiPassword\">WiFi password:</label>\n";
  ptr += "                    <input type=\"password\" class=\"form-control\" id=\"wifiPassword\" name=\"wifiPassword\" value=\"\">\n";
  ...
  ptr += "                    <input type=\"text\" class=\"form-control\" id=\"senderEmail\" name=\"senderEmail\" value=\"" + emailSenderAccount + "\">\n";
  ...
  ptr += "                    <input type=\"password\" class=\"form-control\" id=\"senderEmailPassword\" name=\"senderEmailPassword\" value=\"\">\n";
  ...
  ptr += "                    <input type=\"text\" class=\"form-control\" id=\"senderSmtServerName\" name=\"senderSmtServerName\" value=\"" + smtpServer + "\">\n";
  ...
  ptr += "                    <input type=\"text\" class=\"form-control\" rows=\"5\" id=\"senderSmtServerPort\" name=\"senderSmtServerPort\" value=\"" + String(smtpServerPort) + "\">\n";
  ...
  ptr += "                    <input type=\"text\" class=\"form-control\" id=\"receiverEmail\" name=\"receiverEmail\" value=\"" + emailRecipientAccount + "\">\n";
  ...
  ptr += "                <input id=\"applyChangesButton\" type=\"submit\" class=\"btn btn-success\" value=\"Apply change\">\n";
